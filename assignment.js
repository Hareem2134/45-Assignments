...
console.log("\nQuestion 4\n");
let quote = `"The one who cares for an orphan will be together with me in Paradise like this, and he held his two fingers together".`;
let author = `Prophet Muhammad PBUH`;
console.log(`${author} once said: ${quote}`);
// Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
console.log("\nQuestion 5\n");
let famous_person = `Prophet Muhammad PBUH once said: `;
let message = `"Charity does not decrease wealth"`;
...
console.log("\nQuestion 9\n");
let favoriteNumber = 3; //Storing my favourite number in a variable
...
console.log("\nQuestion 11\n");
let friendsNames = ["Maliya", "Fatima", "Aliya", "Shazia"];
...
console.log("\nQuestion 13\n");
let favouriteTransportation = ["BMW", "Tesla", "Mercedes"];
...
console.log("\nQuestion 14\n");
let invites = ["Maliha", "Shazia", "Aliya"];
...
console.log("\nQuestion 18\n");
let places = ["K2 Base Camp", "Norway", "Iceland", "Maldives", "Switzerland"];
...
console.log("\nQuestion 20\n");
let list = ["K2", "Iceland", "Norway", "Urdu", "BMW", "Parrot"];
console.log(list);
...
console.log("\nQuestion 22\n");
let favoriteCar = ["BMW", "Mercedes", "Tesla"];
...
console.log("\nQuestion 29\n");
let my_favorite_fruits = ["Banana", "Strawberry", "Apple", "Mango"];
...
console.log("\nQuestion 30\n");
let userName = ["admin", "hareem2134", "aliya93", "fatima23", "maliha88"];
...
console.log("\nQuestion 32\n");
let current_users = ["asma123", "tayyab654", "sana876", "rida989", "amna656"];
let new_users = ["esha436", "tayyab654", "maria622", "maliha829", "kinza864"];
...
console.log("\nQuestion 34\n");
let favoritePizza = ["Fajita", "Paperoni", "Creamy Cheese"];
...
console.log("\nQuestion 41\n");
let magicians = ["Alpha", "Johny", "Bravo"];
...
console.log("\nQuestion 43\n");
let original_magicians = ["Alpha", "Johny", "Bravo"];
